...
must(cfg.includes("MASTER_AI_BUILD='18.17.19-CANDIDATE'") || cfg.includes('MASTER_AI_BUILD="18.17.19-CANDIDATE"'), 'candidate build drift');
must(cfg.includes('quota-safe-v181719.js'), '18.17.19 quota-safe patch missing');
