...
(function(){
  ...
  async function installPatch(cloud){
    ...
    cloud.subscribe=function(profile,onRows){
      ...
      return (async()=>{
        if(role==='owner')await refreshGoogleCfg();
        ...
        /* Full Google reconciliation is manual-only in 18.17.16.
